            ...
            <div className="hidden md:block">
              <div className="relative">
                ...
                <img 
                  src="/hero-image.png" 
                  alt="Clean City" 
                  className="relative rounded-3xl shadow-2xl bg-emerald-800/50 w-full h-96 object-cover"
                  onError={(e) => {
                    e.target.style.display = 'none';
                    e.target.nextSibling.style.display = 'flex';
                  }}
                />
                <div className="hidden absolute inset-0 rounded-3xl bg-emerald-800/50 items-center justify-center">
